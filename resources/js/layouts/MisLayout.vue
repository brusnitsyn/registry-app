...
<template>
    <NConfigProvider :theme="currentTheme" :locale="ruRU" :date-locale="dateRuRU">
        <NLayout position="absolute">
            <NLayout :has-sider="mediumAndLarger" position="absolute">
                ...
                <NLayout style="padding: 8px;" :style="theme === 'dark' ? 'background-color: rgb(24, 24, 28);' : 'background-color: rgb(250, 250, 250);'"  :native-scrollbar="false">
                    <NFlex vertical style="background-color: var(--n-color); height: calc(100vh - 16px); border-radius: 12px; padding-left: 16px; padding-right: 16px; padding-bottom: 16px; overflow: hidden">
